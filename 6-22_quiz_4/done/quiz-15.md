15. What is the server-side rendering? What is the advantage of server-side rendering? What are the use cases for server-side rendering and client-side rendering?
